...
Running into errors is an inevitable part of working with Git and GitHub, but we're here to help! Drop a message in the [#github Slack channel](https://theurbaninstitute.slack.com/archives/C6J9AALDR) when you have issues, or email Aaron Williams ([awilliams@urban.org](mailto:awilliams@urban.org)) or Erika Tyagi ([etyagi@urban.org](mailto:etyagi@urban.org)).  
